...
export function LanguageSelector() {
  ...
  return (
    <button
      ...
      className="group relative flex min-h-11 items-center gap-3 overflow-hidden rounded-full border border-[var(--brand-primary)] !bg-transparent px-5 py-2.5 backdrop-blur-xl transition-all duration-300 hover:border-[var(--brand-cyan-bright)] hover:shadow-[var(--shadow-neon-blue)] dark:!bg-transparent"
    >
      <span
