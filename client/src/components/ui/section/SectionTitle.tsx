    ...
    <>
      {label && (
        <p
          className={cn(
            ...
            isLight
              ? "border border-[var(--brand-cyan)]/25 bg-[linear-gradient(135deg,rgba(234,246,255,0.78),rgba(0,209,255,0.1))] text-[var(--brand-primary)] shadow-[0_14px_35px_rgba(10,132,255,0.14)] backdrop-blur-xl"
      ...
      <h2
        className={cn(
          ...
          isLight
            ? "bg-[linear-gradient(110deg,#050816_0%,#0A84FF_46%,#7B61FF_100%)] bg-clip-text text-transparent drop-shadow-[0_12px_30px_rgba(10,132,255,0.14)]"
