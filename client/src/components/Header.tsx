    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "bg-white/96 backdrop-blur-2xl shadow-[0_18px_40px_rgba(10,17,40,0.14)] dark:bg-[#050B16]/96 dark:shadow-[0_18px_60px_rgba(0,0,0,0.65)]"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <nav className={cn("flex items-center justify-between transition-all duration-500", scrolled ? "h-20 md:h-24" : "h-24 md:h-28")}>
            <Link href={`/${lang}`} className="flex items-center gap-2 transition-all duration-500 hover:opacity-90">
              <img src="/logo_sapiente_transparente.png" alt="SAPIENTE.AI" className="h-[67px] w-auto object-contain md:h-[77px] lg:h-[84px]" />
            </Link>
            ...
            <div className="hidden items-center gap-8 lg:flex xl:gap-10">
              ...
              <div className="relative" onMouseEnter={() => setIsLegalOpen(true)} onMouseLeave={() => setIsLegalOpen(false)}>
                ...
                <div
                  className={cn(
                    "absolute top-full -left-4 w-60 origin-top-left pt-4 transition-all duration-300",
