export const quizContentPt = {
  ...
  questions: [
    ...
    },
    {
      ...
      q: "Como a IA reduz custos empresariais através da automatização inteligente?",
      opts: [
        "Apenas substituindo funcionários",
        "Automatizando processos repetitivos, otimizando recursos e reduzindo erros operacionais",
        "Aumentando o número de tarefas manuais",
        "Não tem impacto nos custos",
      ],
      correct: 1,
      explain:
        "A IA automatiza fluxos de trabalho, elimina retrabalho, otimiza recursos e reduz custos operacionais significativamente.",
    },
    {
      cat: "IA Pessoal",
      q: "Como a IA pode ajudar no dia a dia pessoal?",
      opts: [
    ...
    },
    {
      ...
      opts: [
        ...
        "Ignorando preferências individuais",
