export const servicesPT = {
  sections: [
    { id: "ia",              navLabel: "IA",               icon: "Sparkles",      backgroundImage: "/media/bg/servicos/bg_Serviços_ia.webp" },
    { id: "automacao",       navLabel: "Automação",         icon: "Zap",           backgroundImage: "/media/bg/servicos/bg_Serviços_automacao.webp" },
    { id: "crescimento",     navLabel: "Crescimento",       icon: "TrendingUp",    backgroundImage: "/media/bg/servicos/bg_Serviços_crescimento.webp" },
    { id: "dados-bi",        navLabel: "Dados & BI",        icon: "BarChart3",     backgroundImage: "/media/bg/servicos/bg_Serviços_dados.webp" },
    { id: "desenvolvimento", navLabel: "Website",           icon: "Globe",         backgroundImage: "/media/bg/servicos/bg_Serviços_website.webp" },
    { id: "marketing",       navLabel: "Marketing Digital", icon: "MessageCircle", backgroundImage: "/media/bg/servicos/bg_Serviços_mkt_digital.webp" },
  ],
