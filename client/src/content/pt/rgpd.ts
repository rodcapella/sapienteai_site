...
export const rgpdContentPT = {
  ...
  sections: [
    ...
    },
    {
      ...
      icon: Icons.Globe, // Representa a atuação internacional/europeia
    ...
    {
      id: "local-repository",
      icon: Icons.Database, // Representa o repositório de dados/código
    ...
    },
    {
      ...
      icon: Icons.ShieldCheck, // Representa proteção desde a concepção
    ...
    },
    {
      ...
      icon: Icons.Lock, // Representa criptografia e trancas de segurança
    ...
    },
    {
      ...
      icon: Icons.UserCheck, // Representa o titular do dado e seus direitos
    ...
    {
      id: "ai-ethics-eu",
      icon: Icons.ShieldCheck, // Ou use "Brain" se preferir reforçar a parte de IA ética
    ...
    {
      id: "retention",
      icon: Icons.History, // Representa o ciclo de vida/tempo de retenção
