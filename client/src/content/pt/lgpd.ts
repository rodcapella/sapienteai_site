...
export const rgpdContentPT = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "10. Contato e Proteção de Dados",
      content:
        "A SAPIENTE.AI mantém processos internos de supervisão para garantir a conformidade contínua. Para questões relacionadas com a proteção de dados ou detalhes técnicos sobre a segurança dos nossos repositórios, utilize os nossos canais de contato oficiais."
    }
  ]
};