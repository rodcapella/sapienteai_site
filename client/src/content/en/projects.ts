export const projectsEN = {
  ...
  cta: {
    title: "Have an idea with",
    title_highlight: "room to grow?",
    description: "We turn real needs into digital solutions that are",
    description_highlight: "clear, useful and ready to evolve.",
    button: "Talk to us",
  },
};
