// /content/en/terms.ts
import { AlertTriangle, Ban, CheckCircle, Cpu, FileText, Globe, RefreshCw, Scale, ShieldAlert, Zap } from "@/lib/icons";

export const termsContentEN = {
  title: "Terms of Service",
  subtitle: "Standard conditions for the use of",
  highlight: "services and platforms.",
