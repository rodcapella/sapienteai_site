...
const copy = {
  pt: {
    ...
    form: {
      ...
      rateLimited: "Atingiu o limite de 2 análises. Aguarde 2 horas antes de tentar novamente.",
  ...
  en: {
    ...
    form: {
      ...
      rateLimited: "You have reached the limit of 2 analyses. Please wait 2 hours before trying again.",
