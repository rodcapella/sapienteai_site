  ...
  return (
    <SectionCard
      className={cn(
        ...
        isOpen ? "border-[var(--brand-cyan)]/70" : "border-[#0A8AFF]/18",
      )}
      onClick={onToggle}
    >
      <div className="relative p-6 md:p-8">
        ...
        <div className="relative z-10 flex items-start justify-between gap-5">
          <div className="flex items-start gap-4 md:gap-5">
            ...
            <div>
              ...
              <h3 className="font-heading text-xl font-black leading-tight tracking-tight text-[#0A1024] md:text-2xl">
                {item.question}
              </h3>
            </div>
          </div>
        ...
        <div className={cn("overflow-hidden transition-all duration-700", isOpen ? "mt-7 max-h-[900px] opacity-100" : "max-h-0 opacity-0")}>
          <div className="ml-0 border-t border-[#0A8AFF]/14 pt-6 md:ml-[4.25rem]">
            <p className="rounded-2xl border border-[var(--brand-cyan)]/16 bg-[#06102A]/[0.04] px-5 py-5 text-base font-medium leading-relaxed text-[#0A4F8F] md:text-lg">
              {item.answer}
            </p>
          </div>
        </div>
    ...
    <div className="flex flex-col">
      ...
      <Section className="relative flex-grow overflow-hidden bg-[#EAF6FF] py-24 md:py-36">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6">
          <Reveal>
            <div className="mb-12 rounded-[2rem] border border-[#0A8AFF]/20 bg-white/72 p-6 text-center shadow-[0_18px_45px_rgba(10,17,40,0.1)] backdrop-blur-xl md:p-8">
              ...
              <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-[#0A1024]/70 md:text-lg">
                {lang === "pt"
