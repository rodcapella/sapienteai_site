  ...
  return (
    <main className="quiz-ai-page">
      <div className="quiz-lang-toggle">
        <button type="button" className={lang === "pt" ? "active" : ""} onClick={() => handleLanguageChange("pt")}>
          PT
        </button>
        <button type="button" className={lang === "en" ? "active" : ""} onClick={() => handleLanguageChange("en")}>
          EN
        </button>
      </div>
      ...
      {screen === "start" && (
        <section className="quiz-screen quiz-start anim-in">
          ...
          <h1 className="quiz-title anim-in anim-d2">
            {content.title}{" "}
            <span className="neon-blue neon-text-glow">{content.highlight}</span>?
          </h1>
