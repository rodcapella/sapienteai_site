...
import { ArrowRight, RotateCcw, Rocket, Zap } from "lucide-react";
      ...
      {screen === "start" && (
        <section className="quiz-screen quiz-start anim-in">
          ...
          <h1 className="quiz-title anim-in anim-d2">
            {content.title}{" "}
            <span className="neon-blue neon-text-glow">
              {content.highlight}
            </span>
            ?
          </h1>
            ...
            <article className="quiz-card anim-in">
              ...
              {selected !== null && (
                <div
                  className={[
                    "quiz-feedback",
                    selected === question.correct ? "is-correct" : "is-wrong",
                  ].join(" ")}
                >
                  <strong>
