...
export default function Team() {
  ...
  return (
    <div className="flex flex-col">
      <InternalHero label={lang === "en" ? "Founders" : "Fundadores"} title={content.hero.title} highlight={content.hero.title_highlight} subtitle={content.hero.subtitle} imageAlt="Sapiente.AI team" />
