...
export function getIndexableRoutes() {
  ...
  pages.push(
    ...
    { lang: "pt", routePath: "/pt/seo-aeo-validator", priority: "0.9", title: "Validador de SEO e AEO Gratuito", description: "Use o Validador de SEO e AEO gratuito da Sapiente.AI para medir a visibilidade do seu website no Google e a preparação para respostas de IA.", heading: "Validador de SEO e AEO", keywords: "validador de SEO e AEO, validador SEO gratuito, análise SEO online, teste SEO website, análise AEO, visibilidade no Google, otimização para inteligência artificial" },
    { lang: "en", routePath: "/en/seo-aeo-validator", priority: "0.9", title: "Free SEO and AEO Validator", description: "Use Sapiente.AI's free SEO and AEO Validator to assess your website's Google visibility and readiness for AI-generated answers.", heading: "SEO and AEO Validator", keywords: "SEO and AEO validator, free SEO validator, online SEO analysis, website SEO test, AEO analysis, Google visibility, AI search optimization" },
  );
